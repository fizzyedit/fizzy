...
//! consumer follows.
//!
//! It lives in the `sdk/` package (rather than beside `sdk/src/version.zig`, where the rest of
...
//! is off-limits to it. The runtime side reaches *in* instead: `sdk/src/version.zig` re-exports
