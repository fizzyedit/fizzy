//! An opaque handle to an open document. Fizzy stores these per tab/workspace
...
//! `ptr` is a `*pixi.internal.File`; a text plugin would point it at its own type.
...
owner: *Plugin,
/// Fizzy-assigned stable identifier for tabs/workspaces.
id: u64,
